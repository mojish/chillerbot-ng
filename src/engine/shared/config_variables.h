...
MACRO_CONFIG_STR(PlayerName, player_name, 16, "nameless FFe", CFGFLAG_SAVE|CFGFLAG_CLIENT, "Name of the player")
...
MACRO_CONFIG_INT(ClOverlayEntities, cl_overlay_entities, 100, 0, 100, CFGFLAG_CLIENT, "Overlay game tiles with a percentage of opacity (chillerbot default on)")
